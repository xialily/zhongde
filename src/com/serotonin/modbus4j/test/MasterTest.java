...
public class MasterTest {
    public static void main(String[] args) throws Exception {
        ...
        ModbusMaster master = modbusFactory.createTcpMaster(ipParameters, false,null);
    ...
    public static void readHoldingRegistersTest(ModbusMaster master, int slaveId, int start, int len) {
        try {
            ...
            if (response.isException())
                ...
                System.out.println("MasterTester:" + Arrays.toString(response.getShortData()));
        }
        catch (ModbusTransportException e) {
            e.printStackTrace();
        }
    ...
    public static void readExceptionStatusTest(ModbusMaster master, int slaveId) {
        try {
            ...
            if (response.isException())
                System.out.println("MasterTester:Exception response: message=" + response.getExceptionMessage());
            else
                System.out.println("MasterTester:" + response.getExceptionStatus());
        }
        catch (ModbusTransportException e) {
            e.printStackTrace();
        }
    ...
    public static void reportSlaveIdTest(ModbusMaster master, int slaveId) {
        try {
            ...
            if (response.isException())
                ...
                System.out.println("MasterTester:" + Arrays.toString(response.getData()));
        }
        catch (ModbusTransportException e) {
            e.printStackTrace();
        }
