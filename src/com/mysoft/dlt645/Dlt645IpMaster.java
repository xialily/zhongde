 ...
 *
 */
public class Dlt645IpMaster extends Dlt645Master {
...
//	private LqRequestHandler lqRequestHandler;
 ...
 //   }
	...
	public void init() throws ModbusInitException{
    	dltMessageParser=new Dlt645IpSerialMessageParser(true); 
...
//    	lqRequestHandler=new LqRequestHandler(this,lqresponse);
	...
	public Dlt645IpMaster(IpParameters params, boolean keepAlive, Socket socket) {
		super();
		ipParameters = params;
	...
	@Override
	synchronized public Dlt645Message send(Dlt645Message request)
		...
		ipRequest=new Dlt645IpSerialMessageRequest(request);
...
//				System.out.print(Integer.toHexString(bb&0xff)+" ");
		...
		Dlt645IpSerialMessageResponse ipResponse;
		try {
			ipResponse = (Dlt645IpSerialMessageResponse) conn.send(ipRequest);
			if (ipResponse == null)
				return null;
		            if(conn.DEBUG){
    		byte b[]=null;
...
//    			System.out.print(Integer.toHexString(bb&0xff)+" ");
			...
			return ipResponse.getDltMessage();
		} catch (Exception e) {
			if (keepAlive) {
