 ...
 *
 */
public class CjtUtils extends ModbusUtils{
public static int calculateSum(CjtMessage dltMessage){
...
public static void checkSum(CjtMessage dltMessage, ByteQueue queue) throws ModbusTransportException{
...
*/
	...
	long a=CjtUtils.BCDToLong(data);
	System.out.print(a);
}
