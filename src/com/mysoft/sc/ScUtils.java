 ...
 *
 */
public class ScUtils extends ModbusUtils{
public static int calculateSum(ScMessage dltMessage){
	...
	int sum1=sum&0xff;
	int sum2=(sum+sum1)&0xff;
	sum=(sum1<<8)|sum2;
	return sum;
}
public static void checkSum(ScMessage dltMessage, ByteQueue queue) throws ModbusTransportException{
